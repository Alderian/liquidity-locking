...
## All module dependencies are managed by pnpn/yarn to be compatible with hardhat
## We use fuondry to augment our tests

all: solc clean build  # remove install update
